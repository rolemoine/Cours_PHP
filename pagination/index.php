		...
		<! cette partie sert a afficher les donnees sous forme d un tableau -->
			...
			<?php
					...
					while ($ligne = mysqli_fetch_array($table)) {
						...
						echo'<td>'. $ligne[2].'</td>';
						echo'<tr>';
		//			echo $ligne[0] . ' ' . $ligne[3] . '</br>';  // ici seul 2 colonnes seront affichées, celles contenant le code du salarie et celle contenant le salaire du salarie correspondant
